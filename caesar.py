...
#
# Aufgabe 2, Cäsar-Verschlüsselung (Python):
# Das Tool verschlüsselt einen vorgegebenen Text in dem es jeden Buchstaben um eine durch den Schlüssel 
# vorgegebene Anzahl an Buchstaben zyklisch verschiebt. Ebenso kann man einen verschlüsselten Text 
# entschlüsseln, wenn der Schlüssel 0 gewählt wird. Die Umlaute "ä, ö, ü, ß" müssen als "ae, oe, ue, ss" 
# geschrieben werden. 
#
# Anleitung:
# Verschlüsselung auf Konsole wie folgt aufrufen: python caesar.py "Text" Schlüssel
# Falls ein verschlüsselter Text entschlüsselt werden soll Programm auf Konsole mit Schlüssel 0 aufrufen.
# 
# Probleme:
# - Die Methode "crack_caesar" liefert für unsinnige (z.B. "xxxx") und teilweise auch für kurze Texte (z.B. "Das 
#   ist ein Text.") keine verlässliche Entschlüsselung, falls dieser Text zuvor verschlüsselt wurde. Wie lang 
#   ein Text mindestens sein muss scheint mit der Verteilung der Buchstaben im zu verschlüsselten Text in Bezug 
#   auf den Beispieltext zu liegen. Der Wert von Chi-squared ist in diesen Fällen für den richtigen Schlüssel 
#   höher als bei einem anderen, falschen Schlüssel, weshalb die korrekte Entschlüsselung scheitert. Auf Grund 
#   des Hinweises in der Aufgabenstellung, dass nur mit "großer Wahrscheinlichkeit" die Entschlüsselung glückt, 
#   wird diese Unzuverlässigkeit des Programms hingenommen und hiermit auf das vorhandene Problem verwiesen.
# 
# - Dem Beispieltext mussten die Buchstaben "q" und "x" hinzugefügt werden, da die minimale Anzahl eines Buch-
#   stabens auf Grund des Chi-squared-Tests mindestens 1 sein muss, da andernfalls durch 0 dividiert werden würde.
#
# Lösung des im Aufgabenteil d) verschlüsselten Texts:
# "And so it is. For this time I will leave you: To-morrow, if you please to speak with me, 
